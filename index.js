...
//step 2 - we need a conditional - if the array is 31 flavours we want to see true otherwise we want to see false
...
function copy(arr){
    let my31originalflavors = [...arr];
    return my31originalflavors;
}
